...
def burgers_2d(spacing: arr, nu: tuple[float, float], field: arr) -> arr:
    """
...
def rk1(spacing: arr, nu: tuple[float, float], field: arr, dt: float) -> arr:
    """
    spacing: [Ny, Nx, 2] distance between grid points
    nu: [2, ] diffusion coefficient
    field: [Ny, Nx, 2], xy-field of each grid point
...
def rk2(spacing: arr, nu: tuple[float, float], field: arr, dt: float) -> arr:
    """
    spacing: [Ny, Nx, 2] distance between grid points
    nu: [2, ] diffusion coefficient
    field: [Ny, Nx, 2], xy-field of each grid point
...
def rk4(spacing: arr, nu: tuple[float, float], field: arr, dt: float) -> arr:
    """
    spacing: [Ny, Nx, 2] distance between grid points
    nu: [2, ] diffusion coefficient
    field: [Ny, Nx, 2], xy-field of each grid point
